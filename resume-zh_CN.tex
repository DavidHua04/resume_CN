...
\section{教育背景}
\datedsubsection{\textbf{英属哥伦比亚大学},计算机科学与技术,\textit{理学学士}}{2024.9 - 2027.4}
\ \textbf{绩点4.33 / 4.33 (前1\%)}, 英属哥伦比亚大学理学院奖学金,院长学者
\datedsubsection{\textbf{香港中文大学（深圳）},计算机工程,\textit{工学学士}}{2023.9 - 2024.9}
\ \textbf{绩点3.7 / 4.0 (前5\%)}
...
\begin{itemize}[parsep=0.2ex]
  \item \textbf{编程语言}: JavaScript (React, Node.js), HTML/CSS, Python, Go, SQL, C, Shell
